...
default_main_vert_tile_layout_key="M-6"
default_main_horz_tile_layout_key="M-7"
...
setup_main_vert_tile_key_binding() {
	local key="$(get_tmux_option "@main_vert_tile_layout_key" "$default_main_vert_tile_layout_key")"
	tmux bind-key "$key" run-shell "$CURRENT_DIR/layout.tmux main_vertical_tile_layout"
}

main_vertical_tile_layout() {
	local main_pane_width_percent=$(get_tmux_option "@main_pane_width_percent" "$default_main_pane_width_percent")
...
setup_main_horz_tile_key_binding() {
	local key="$(get_tmux_option "@main_horz_tile_layout_key" "$default_main_horz_tile_layout_key")"
	tmux bind-key "$key" run-shell "$CURRENT_DIR/layout.tmux main_horizontal_tile_layout"
}

main_horizontal_tile_layout() {
	local main_pane_height_percent=$(get_tmux_option "@main_pane_height_percent" "$default_main_pane_height_percent")
